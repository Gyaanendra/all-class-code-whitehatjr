...
column_names = ["preg","glu","bp","st","ins","bmi","dpf","age","outcome"]
data_file = pd.read_csv("c119/diabetes.csv",names=column_names).iloc[1:]

features =["preg","glu","bp","ins","bmi","dpf","age"]
